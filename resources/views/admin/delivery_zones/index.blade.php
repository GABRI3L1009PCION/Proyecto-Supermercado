...
@section('content')
    ...
    <style>
        ...
        .zones-actions { display: flex; gap: 10px; align-items: center; flex-wrap: wrap; }
        ...
        .btn-secondary { color: #1f2937; border-color: #d1d5db; }
    ...
    <div class="zones-wrapper">
        <div class="zones-header">
            ...
            <div class="zones-actions">
                <a href="{{ route('admin.panel') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver al panel</a>
            </div>
        </div>
